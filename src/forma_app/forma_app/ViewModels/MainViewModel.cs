...
{
    public class MainViewModel(NavigationService navigationService) : BaseViewModel
    {
        ...
        public RelayCommand RegisterCommand => new RelayCommand(async () => await navigationService.OnNavigateAsync(NavigationService.NavigationPageEnum.Register, false).ConfigureAwait(false));
    }
}
